...
export const ECONOMY = {
  ...
  LOOT_BOXES: {
    ...
    arcana: { cost: 3500, pity: 10, rarityTarget: 'epic'      },
    mythic: { cost: 8000, pity: 10, rarityTarget: 'legendary' },
  },
  BOX_RATES: {
    wood:   { common:1.00, uncommon:0,    rare:0,    epic:0,    legendary:0,    mythic:0    },
    iron:   { common:0.20, uncommon:0.65, rare:0.15, epic:0,    legendary:0,    mythic:0    },
    gold:   { common:0,    uncommon:0.20, rare:0.65, epic:0.15, legendary:0,    mythic:0    },
