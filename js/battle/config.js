...
export const WORLD_DUNGEONS = [
  ...
  return Array.from({ length: 10 }, (_, i) => {
    ...
    // Boss: valori propri da dungeon_config (boss_hp, boss_atk, boss_def)
    // Stanze normali: scala esponenziale uniforme per hp/atk/def
    const hp  = isBoss ? bossHp  : Math.round(baseHp  * Math.pow(hpScale  ?? 1.18, i));
    const atk = isBoss ? bossAtk : Math.round(baseAtk * Math.pow(atkScale ?? 1.18, i));
    const def = isBoss ? bossDef : Math.round(baseDef * Math.pow(defScale ?? 1.18, i));
...
// ── WORLD_DUNGEONS ───────────────────────────────────────────
// Valori calibrati — bilanciati con nuova _buildRooms.
// mapX/mapY/name/description/theme: invariati.
// Numeri: ricalibrati per TTK 6-9t st1, boss TTK 20-30t.
export const WORLD_DUNGEONS = [
  { id:'dungeon_01', name:'Faro della Costa',
    ...
    rooms: _buildRooms({ baseHp:60,  baseAtk:7,  baseDef:2,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:5,    xpPerRoom:8,    bossId:'sea_guardian',      bossHp:320,  bossAtk:18,  bossDef:8   }) },
  { id:'dungeon_02', name:'Porto Meridionale',
    ...
    rooms: _buildRooms({ baseHp:75,  baseAtk:9,  baseDef:3,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:12,   xpPerRoom:18,   bossId:'harbor_master',     bossHp:400,  bossAtk:22,  bossDef:10  }) },
  { id:'dungeon_03', name:'Isola Fortificata',
    ...
    rooms: _buildRooms({ baseHp:90,  baseAtk:12, baseDef:4,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:22,   xpPerRoom:35,   bossId:'iron_warden',       bossHp:500,  bossAtk:28,  bossDef:13  }) },
  { id:'dungeon_04', name:"Villaggio sull'Isola",
    ...
    rooms: _buildRooms({ baseHp:110, baseAtk:14, baseDef:5,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:35,   xpPerRoom:55,   bossId:'village_elder',     bossHp:600,  bossAtk:33,  bossDef:15  }) },
  { id:'dungeon_05', name:"Montagne dell'Isola",
    ...
    rooms: _buildRooms({ baseHp:130, baseAtk:16, baseDef:6,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:50,   xpPerRoom:80,   bossId:'stone_titan',       bossHp:730,  bossAtk:38,  bossDef:18  }) },
  { id:'dungeon_06', name:'Foresta Intricata',
    ...
    rooms: _buildRooms({ baseHp:155, baseAtk:19, baseDef:8,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:70,   xpPerRoom:115,  bossId:'ancient_treant',    bossHp:880,  bossAtk:44,  bossDef:22  }) },
  { id:'dungeon_07', name:'Torre del Sentiero',
    ...
    rooms: _buildRooms({ baseHp:185, baseAtk:22, baseDef:9,  hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:95,   xpPerRoom:160,  bossId:'tower_sentinel',    bossHp:1050, bossAtk:50,  bossDef:26  }) },
  { id:'dungeon_08', name:'Fortezza del Nord',
    ...
    rooms: _buildRooms({ baseHp:220, baseAtk:26, baseDef:12, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:130,  xpPerRoom:220,  bossId:'fortress_lord',     bossHp:1280, bossAtk:58,  bossDef:31  }) },
  { id:'dungeon_09', name:'Torre Settentrionale',
    ...
    rooms: _buildRooms({ baseHp:260, baseAtk:30, baseDef:14, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:175,  xpPerRoom:300,  bossId:'frost_watcher',     bossHp:1550, bossAtk:67,  bossDef:37  }) },
  { id:'dungeon_10', name:'Castello della Capitale',
    ...
    rooms: _buildRooms({ baseHp:310, baseAtk:34, baseDef:17, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:230,  xpPerRoom:400,  bossId:'capital_king',      bossHp:1880, bossAtk:77,  bossDef:43  }) },
  { id:'dungeon_11', name:'Vulcano Attivo',
    ...
    rooms: _buildRooms({ baseHp:365, baseAtk:39, baseDef:20, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:300,  xpPerRoom:530,  bossId:'magma_lord',        bossHp:2250, bossAtk:88,  bossDef:50  }) },
  { id:'dungeon_12', name:'Oasi del Deserto',
    ...
    rooms: _buildRooms({ baseHp:430, baseAtk:44, baseDef:24, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:380,  xpPerRoom:680,  bossId:'sand_pharaoh',      bossHp:2700, bossAtk:100, bossDef:58  }) },
  { id:'dungeon_13', name:'Lago Tropicale',
    ...
    rooms: _buildRooms({ baseHp:505, baseAtk:50, baseDef:28, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:470,  xpPerRoom:860,  bossId:'lagoon_hydra',      bossHp:3200, bossAtk:113, bossDef:67  }) },
  { id:'dungeon_14', name:'Castello Meridionale',
    ...
    rooms: _buildRooms({ baseHp:590, baseAtk:57, baseDef:33, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:570,  xpPerRoom:1050, bossId:'shadow_duke',       bossHp:3800, bossAtk:128, bossDef:77  }) },
  { id:'dungeon_15', name:'Isole Fluttuanti Est',
    ...
    rooms: _buildRooms({ baseHp:690, baseAtk:64, baseDef:38, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:680,  xpPerRoom:1280, bossId:'sky_colossus',      bossHp:4500, bossAtk:144, bossDef:88  }) },
  { id:'dungeon_16', name:'Isole Fluttuanti Ovest',
    ...
    rooms: _buildRooms({ baseHp:810, baseAtk:73, baseDef:45, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:820,  xpPerRoom:1550, bossId:'void_titan',        bossHp:5400, bossAtk:163, bossDef:101 }) },
  { id:'dungeon_17', name:'Castello Fluttuante',
    ...
    rooms: _buildRooms({ baseHp:950, baseAtk:83, baseDef:53, hpScale:1.18, atkScale:1.18, defScale:1.18, baseGold:1000, xpPerRoom:1900, bossId:'celestial_overlord', bossHp:6400, bossAtk:183, bossDef:115 }) },
];
